...
return {
  ...
  Statement = { fg = c.orange.base, bold = o.bold }, -- (preferred) any statement
  Conditional = { fg = c.orange.base, bold = o.bold }, --  if, then, else, endif, switch, etc.
  Repeat = { fg = c.orange.base, bold = o.bold }, --   for, do, while, etc.
  Label = { fg = c.orange.base, bold = o.bold }, --    case, default, etc.
  Operator = { fg = c.orange.bright, bold = o.bold }, -- "sizeof", "+", "*", etc.
  Keyword = { fg = c.orange.base, bold = o.bold }, --  any other keyword
  Exception = { fg = c.red.base, bold = o.bold }, --  try, catch, throw

  Comment = { fg = c.comment, italic = o.italic },
